...
# UpDownCounter
updown_counter = meter.create_up_down_counter("testing-updown_counter")
...
# Histogram
histogram = meter.create_histogram("testing-histogram")
...
# Async Gauge
gauge = meter.create_observable_gauge("testing-gauge-me-custom", [observable_gauge_func])
